...
<div style="display:grid;grid-template-columns:repeat(4,1fr);gap:24px;">
  ${agents
    .map(
      (a) => `
  <a href="/agents/${a.slug}" style="text-decoration:none;color:inherit;display:block;background:#0f0f0f;border:1px solid rgba(255,255,255,0.08);border-radius:4px;overflow:hidden;">
